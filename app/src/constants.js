...
const nightIcons = {
    ...
    53: 'wi wi-sprinkle',
    55: 'wi wi-showers',
    56: 'wi wi-night-alt-sleet',
    57: 'wi wi-night-alt-sleet',
    61: 'wi wi-rain',
    63: 'wi wi-rain',
    65: 'wi wi-rain',
    66: 'wi wi-rain-mix',
...
export const slogans = {
    ...
    1: { name: 'Slogan', phrase: 'Clouds and sunshine, the perfect mix.' }, 
    2: { name: 'Slogan', phrase: 'Overcast skies, but the day is still yours to seize!' },
    3: { name: 'Proverb', phrase: 'When wooden chairs creak, rain will come within a week.' },
    45: { name: 'Proverb', phrase: 'Fog in the morning, travelers take warning.' },
    48: { name: 'Slogan', phrase: 'Lost in the mist, but found in the moment.' },
    ...
    56: { name: 'Slogan', phrase: 'Chilly rain, a call for cozy moments.' }, 
    57: { name: 'Slogan', phrase: 'Rain and sleet—nature’s chilly embrace.' }, 
    61: { name: 'Slogan', phrase: 'Rainy days are perfect for dreaming big.' },
    63: { name: 'Slogan', phrase: 'Let the rain wash away the stress.' },
    65: { name: 'Slogan', phrase: 'Raindrops keep falling, and so should your worries.' },
    66: { name: 'Slogan', phrase: 'Rain mixed with snow, nature’s perfect duo.' },
    67: { name: 'Proverb', phrase: 'When pipes smell stronger, it’s going to rain.' },
    71: { name: 'Proverb', phrase: 'Snowflakes are kisses from the sky.' },
    73: { name: 'Proverb', phrase: 'When the wind whistles through the trees, snow is on its way.' },
    75: { name: 'Slogan', phrase: 'Blankets of snow, blankets of joy.' },
    77: { name: 'Slogan', phrase: 'Snow crystals, nature’s icy art.' }, 
    ...
    85: { name: 'Slogan', phrase: 'Snowfall by day, a fresh world awaits.' }, 
    86: { name: 'Slogan', phrase: 'Day snow: nature’s softest blanket.' }, 
